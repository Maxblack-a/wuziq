...
const NPC_PERSONALITY = {
  ...
  // 数值来自沈之远的角色设定文档(进攻性55 / 防守能力92 / 布局能力88 /
  // 计算能力82 / 耐心98 / 冒险性35 / 稳定性95 / 心理干扰能力72),核心是
  // "以守为攻"——全场耐心/防守/稳定性都是最高的一档,换算成相对倍数:
  //   caution 明显 >1:防守能力 92 是四人里最高的,对应"很多玩家会发现
  //     明明快要连招了,结果被轻轻挡住";
  //   precision 明显 >1:稳定性 95 + 冒险性 35(全场最低),他的棋不追求
  //     花哨的攻击,而是尽量不给对手留反击余地;
  //   aggression 全场最低(55,连比苏晴的60都更保守):他不会主动搏杀,
  //     进攻更多是防守之后顺势而为,不是林墨那种主动施压,更不是小七的
  //     主动抢攻;
  //   patience 全场最高(远超苏晴的 1.4):对应设定里"耐心 98"和"非常
  //     擅长等待"——候选点权重的锐利度调到最高,选点最集中、最少出人
  //     意料的跳跃,让对手自己按捺不住先露出破绽。
