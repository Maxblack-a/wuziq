  ...
  return (
    <div className={`xq-board-wrap${disabled ? " xq-board-disabled" : ""}`}>
      <div className="xq-board-grid">
        <svg className="xq-wood-defs" width="0" height="0">
          <defs>
            {/* 木纹噪点滤镜:用 feTurbulence 生成细密纹理,叠加一层暖色调,
                比纯色渐变多一点"真实木头"的质感,不用额外配图片素材。 */}
            <filter id="xq-wood-grain">
              <feTurbulence type="fractalNoise" baseFrequency="0.012 0.06" numOctaves="3" seed="7" result="noise" />
              <feColorMatrix in="noise" type="matrix" values="0 0 0 0 0.35  0 0 0 0 0.24  0 0 0 0 0.13  0 0 0 0.22 0" />
            </filter>
          </defs>
        </svg>
        <div className="xq-wood-texture" style={{ filter: "url(#xq-wood-grain)" }} />
